...
public class login extends Activity {
    ...
    String IP_Server="coffeebean-lab.com.mx";//IP DE NUESTRO PC
    String URL_connect="http://"+IP_Server+"/dashboardproyect502/ws/acces.php";//ruta en donde estan nuestros archivos
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        registrar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                String url = "http://"+IP_Server+"/dashboardproyect502/ws/adduser.html";
